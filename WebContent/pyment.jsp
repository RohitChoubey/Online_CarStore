      ...
      <form action="ubook.jsp" method="post">
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="email" name="email" placeholder="rohit@gmail.com" required="">
            <label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
            <input type="text" id="adr" name="address" placeholder="542 Haryana"  required="">
            <label for="city"><i class="fa fa-institution"></i> City</label>
            <input type="text" id="city" name="city" placeholder="Hindustan"  required="">
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                <input type="text" id="zip" name="zip" placeholder="10001"  required="" max="7">
              </div>
            </div>
          </div>
          ...
          <div class="col-50">
            ...
            <div class="icon-container">
             <a href="pyment.jsp"> <i class="fa fa-cc-visa" style="color:navy;" >Credit </i></a>/
              <a href="pyment.jsp"><i class="fa fa-cc-amex" style="color:blue;">Debit</i></a>
             </div>
            <label for="cname">Name on Card</label>
            <input type="text" id="cname" name="cardname" placeholder="Rohit Choubey"  required="">
...
<div class="modal fade" id="e2" tabindex="10" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <b style="color:red;">Please click Okay to continue</b></br>

...
<div class="card-columns">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text"><b>Model: </b> <%=rs.getString("model")%> <br><b>User: </b> <%=rs.getString("username")%> <br><b>Price: </b>Rs. <%=rs.getString("price")%> <br><b>Mileage: </b><%=rs.getString("mileage")%> kmpl<br/></p>

...
<div style="background-color:white">
    ...
    <br><Br><center>
    <h2 style="color:black">Add Discounts Here</h2>
    <table>
    <form action="adddiscountsact.jsp" method="post">
        
            <tr>
    <td height="43"><font color="black"> Discounts</td>
    <td><textarea name="discount" rows="4" cols="22" required="" Placeholder="Add here.." ></textarea></td>
    </tr>

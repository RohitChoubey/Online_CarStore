...
String key = request.getParameter("key");
 ...
 String q = "select * from models where brands like  '%"+key+"%' or model like '%"+key+"%' ";
...
<div class="card-columns">
  ...
  <div class="card">
    <img class="card-img-top" src='images/<%=rs.getString("path")%>' alt="Card image cap" height="200px" width="10px">
    <div class="card-body">

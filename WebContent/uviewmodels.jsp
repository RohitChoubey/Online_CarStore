...
<nav class="navbar navbar-expand-lg navbar-dark "  style="background-color:#000000;" >
    ...
    %>
  		 <h3 style="color:blue;">Hello&nbsp;<%=user%></h3>&nbsp;&nbsp;&nbsp;&nbsp;  
...
<div class="card-columns">
  ...
  <div class="card">
    <img class="card-img-top" src='image/<%=rs.getString("path")%>' alt="Card image cap" height="200px" width="10px"/>
    <div class="card-body">
     <h4 class="card-title"><b>Brand:</b> <%=rs.getString("brands")%></h4>

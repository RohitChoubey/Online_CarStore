...
<script>alert('Booking Request Sent Succesfully...!');</script>
<%}%>
  		...
  		<div class="collapse navbar-collapse " id="navbarSupportedContent">
	   	<form class="form-inline my-1 my-1" action="searchact1.jsp">
		      <input name = "key" class="form-control  mr-1 " type="search" placeholder="Search" aria-label="Search">
      		   	</br><a href="searchactjsp"><img src="baseline-search-24px.svg"></a>
    	  	 </form>	
...
<div class="card-columns">
  ...
  <div class="card">
    <img class="card-img-top" src="image/<%=rs.getString("image")%>" alt="Card image cap">
    <div class="card-body">
      ...
      <p class="card-text"><b>Model: </b> <%=rs.getString("model")%> <br><b>Price: </b>Rs. <%=rs.getString("price")%> <br><b>Mileage: </b><%=rs.getString("mileage")%> kmpl<br/></p>
         <a href="cancelbooking.jsp?model=<%=rs.getString("model")%>&price=<%=rs.getString("price")%>&mileage=<%=rs.getString("mileage")%>&brand=<%=rs.getString("brand")%>"><button type="button" class="btn btn-outline-danger">Cancel Booking</button></a>
  ...
  <%
     ...
     out.println("<center><font color='red' size='4'><br><br><br>No Bookings to Display..</font><br><br><br><br><br><br><br><br><br><br><br><br></center>");
 }
  %>

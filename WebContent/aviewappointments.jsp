...
<div class="card-columns">
  ...
  <div class="card">
    <img class="card-img-top" src='image/<%=rs.getString("image")%>' alt="Card image cap" height="200px" width="10px"/>
    <div class="card-body">
      <h4 class="card-title"><b>Brand:</b> <%=rs.getString("brand")%></h4>
      <p class="card-text"><b>Model: </b> <%=rs.getString("model")%> <br><b>User: </b> <%=rs.getString("username")%> <br><b>Price: </b>Rs. <%=rs.getString("price")%> <br><b>Mileage: </b><%=rs.getString("mileage")%> kmpl<br/><b>Date: </b> <%=rs.getString("dt")%> <br></p>

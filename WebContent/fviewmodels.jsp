...
<div class="card-columns">
  ...
  <div class="card">
    <img class="card-img-top" src='image/<%=rs.getString("path")%>' alt="Card image cap">
    <div class="card-body">
     <h4 class="card-title"><b>Brand:</b> <%=rs.getString("brands")%></h4>
      ...
      <a href="pyment.jsp?model=<%=rs.getString("model")%>&price=<%=rs.getString("price")%>&mileage=<%=rs.getString("mileage")%>&image=<%=rs.getString("image")%>&brand=<%=rs.getString("brands")%>"><button type="button" class="btn btn-outline-danger">Book a Car</button></a>   
      <a href="uappointment.jsp?model=<%=rs.getString("model")%>&price=<%=rs.getString("price")%>&mileage=<%=rs.getString("mileage")%>&image=<%=rs.getString("image")%>&brand=<%=rs.getString("brands")%>"><button class="btn btn-outline-danger">Book Appointment</button></a>    
